        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-72 -translate-x-full lg:translate-x-0 transition-transform bg-emerald-950 text-emerald-50 border-r border-emerald-900/40">
            ...
            <div class="px-4 py-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="students.php" class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-emerald-900/40 text-emerald-50">
            ...
            <main class="px-4 sm:px-6 py-6">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="text-lg text-slate-600"><?php echo (int)$total_students; ?> students enrolled</p>
                    </div>
                    <div class="flex items-center gap-2">
                        ...
                        <a href="users.php?add=1&role=student" class="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700">
                                    ...
                                    <tr class="student-row" data-course="<?php echo htmlspecialchars($primary_course); ?>" data-search="<?php echo htmlspecialchars($search_blob); ?>">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-end gap-2">
                                                <a href="enrollments.php?student_id=<?php echo (int)$s['id']; ?>" class="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-600 hover:bg-slate-50" title="View enrollments" aria-label="View">
                                                    <i class="bi bi-eye"></i>
                                                </a>
