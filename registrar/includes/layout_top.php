        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-40 w-72 -translate-x-full lg:translate-x-0 transition-transform bg-emerald-950 text-emerald-50 border-r border-emerald-900/40">
            ...
            <div class="px-4 py-4">
                ...
                <nav class="space-y-1">
                    ...
                    ?>
                        <a href="<?php echo htmlspecialchars($href); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl <?php echo $link_class; ?>">
                            <i class="bi <?php echo htmlspecialchars($item['icon']); ?>"></i>
                            <span class="text-sm font-medium"><?php echo htmlspecialchars($item['label']); ?></span>
                        </a>
                    <?php endforeach; ?>
                </nav>
            </div>
            ...
            <header class="sticky top-0 z-20 h-16 bg-white/90 backdrop-blur border-b border-slate-200">
                <div class="h-full px-4 sm:px-6 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <button id="sidebarBtn" type="button" class="lg:hidden inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 bg-white hover:bg-slate-50" aria-label="Toggle sidebar">
