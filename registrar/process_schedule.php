...
try {
    switch ($action) {
        case 'add': {
            ...
            activity_log_write('schedule_added', (int)$_SESSION['user_id'], (string)($_SESSION['role'] ?? 'registrar'), [
        ...
        case 'edit': {
            ...
            activity_log_write('schedule_updated', (int)$_SESSION['user_id'], (string)($_SESSION['role'] ?? 'registrar'), [
        ...
        case 'delete': {
            ...
            activity_log_write('schedule_deleted', (int)$_SESSION['user_id'], (string)($_SESSION['role'] ?? 'registrar'), [
